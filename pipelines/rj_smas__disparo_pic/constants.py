...
class PicLembreteConstants(Enum):
    ...
    DISPATCH_APPROVED_COL = "APROVACAO_DISPARO_AVISO"  # column that says if the dispatch was approved
    DISPATCH_DATE_COL = "DATA_DISPARO_AVISO"  # column that contains the date to be made the dispatch
