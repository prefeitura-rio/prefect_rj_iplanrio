...
def rj_iplanrio__vigia_urbano(
    db_database: str = "vigiaurbano",
    db_host: str = "srv000140.infra.rio.gov.br",
    db_port: str = "3306",
    db_type: str = "mysql",
    db_charset: Optional[str] = "utf8",
    execute_query: str = "execute_query",
    dataset_id: str = "brutos_formulario_ocorrencia",
    table_id: str = "table_id",
    infisical_secret_path: str = "/db-vigia-urbano",
