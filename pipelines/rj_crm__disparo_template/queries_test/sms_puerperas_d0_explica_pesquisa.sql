...
WITH segmentacao_original AS (
    ...
    -- propósito: o LEFT JOIN não encontra nada e fica inerte.
        ...
        left join `rj-crm-registry.brutos_salesforce.status_disparo` sd
                ...
                and sd.processado_datahora >= DATETIME_SUB(CURRENT_DATETIME('America/Sao_Paulo'), INTERVAL 300 DAY) -- pessoa só recebe essa mensagem cerca de uma vez por ano podendo pegar mais de uma gravidez
