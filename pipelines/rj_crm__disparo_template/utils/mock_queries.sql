...
(
  ...
  ARRAY<STRUCT<telefone_original STRING, origem STRING, prioridade STRING, telefone_valido_whatsapp STRING, motivo_invalidacao_telefone STRING>>[
    STRUCT('5521981111111', 'SISCEGONHA', '1', '5521981111111', NULL),
    STRUCT('5521971111111', 'SMS_ENRIQUECIMENTO', '2', '5521971111111', NULL),
...
(
  ...
  ARRAY<STRUCT<telefone_original STRING, origem STRING, prioridade STRING, telefone_valido_whatsapp STRING, motivo_invalidacao_telefone STRING>>[
    STRUCT('5521971111111', 'SISCEGONHA', '1', '5521971111111', NULL),
    STRUCT('5510911111111', 'SMS_ENRIQUECIMENTO', '2', '5510911111111', NULL)
  ],
  'ACOMPANHANTE DO PATRICK',
  STRUCT('5521900002222', '5521900002222', NULL)
);
