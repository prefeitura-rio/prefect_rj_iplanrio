...
def rj_smas__api_datametrica_agendamentos(
    ...
    materialize_after_dump = materialize_after_dump if materialize_after_dump is not None else DatametricaConstants.MATERIALIZE_AFTER_DUMP.value
    ...
    if materialize_after_dump:
        print(f"⚠️ DBT materialization requested but not implemented - run manually for dataset_id={dataset_id}, table_id={table_id}")
