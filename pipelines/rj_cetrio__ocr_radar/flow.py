# -*- coding: utf-8 -*-
"""
Flow para dump do banco de dados OCR Radar da CETRIO para o BigQuery.

Este flow faz a ingestão de dados do sistema OCR Radar (leitura de radares),
extraindo informações de equipamentos e histórico de atualizações do banco SQL Server
e carregando no BigQuery para análise.
"""
...
def rj_cetrio__ocr_radar(
    ...
    """
    Flow para dump de tabelas do banco OCR Radar para o BigQuery.

    Extrai dados do SQL Server que armazena informações de equipamentos de radar
    e seus históricos de atualização, permitindo análise e monitoramento.
    ...
    Args:
        ...
        dataset_id: ID do dataset no BigQuery (padrão: ocr_radar)
