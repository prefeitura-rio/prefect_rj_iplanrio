...
def validate_extraction(
    ...
    expected_list = validator.expected_by_pdf.get(pdf_name, [])
    ...
    for exp_nf in expected_list:
        ...
        result = matching.process_single_declaration(
            validator, exp_nf, extracted_nfs, cnpj_start_dates, page_categories or []
        )
...
def validate_batch(validator: "ComplianceValidator", extraction_results: list[dict]) -> dict:
    """
    ...
    for result in extraction_results:
        ...
        validation = validate_extraction(validator, pdf_name, extracted_nfs)
