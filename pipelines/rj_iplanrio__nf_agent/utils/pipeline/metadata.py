...
def generate_metadata(
    ...
    classification_info = get_active_prompt_info(
        "classification", version=processor.prompt_versions.get("classification")
    )
    extraction_info = get_active_prompt_info("extraction", version=processor.prompt_versions.get("extraction"))
