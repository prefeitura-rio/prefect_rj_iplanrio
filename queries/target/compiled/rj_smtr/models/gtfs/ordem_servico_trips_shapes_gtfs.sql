...
WHERE
    ...
    shapes as (
        ...
        where feed_start_date = '2024-12-31'
        ),
        ...
        from
            (
                (
                    ...
                    from __dbt__cte__ordem_servico_sentido_atualizado_aux_gtfs as o
                    left join
                ...
                (
                    select
                        ...
                        indicador_trajeto_alternativo
                    from
                        __dbt__cte__ordem_servico_trajeto_alternativo_sentido_atualizado_aux_gtfs
                        as ot
                    left join
...
where
    feed_start_date = '2024-12-31' and
    (
        (
            feed_start_date >= '2024-08-16'
