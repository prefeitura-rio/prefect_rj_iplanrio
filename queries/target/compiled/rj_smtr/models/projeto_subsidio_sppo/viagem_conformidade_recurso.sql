...
with recursos as (
  ...
  where id_julgamento is null
    ...
    and data_viagem between date('2022-07-01 00:00:00') and date('2022-07-15 00:00:00')
...
gps_viagem as (
  ...
  left join  (
    ...
    where status != "Parado garagem"
      ...
      and data between date('2022-07-01 00:00:00') and date('2022-07-15 00:00:00')
      and timestamp_gps between '2022-07-01 00:00:00' and datetime_add('2022-07-15 00:00:00', interval 3 hour)
