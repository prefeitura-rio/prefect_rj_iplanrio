    ...
    merge into `rj-smtr`.`br_rj_riodejaneiro_veiculos`.`gps_sppo` as DBT_INTERNAL_DEST
        using (
...
SELECT
  ...
  v.distancia,
  "adf1890a5359601ba72af74ffdd322c7c757fed9" as versao
FROM
  registros r
...
ON  
  ...
  AND r.linha = p.linha
WHERE
  date(r.timestamp_gps) between DATE("2023-11-23T00:00:00") and DATE("2023-12-01T23:00:00")
  AND r.timestamp_gps > "2023-11-23T00:00:00" and r.timestamp_gps <="2023-12-01T23:00:00"
